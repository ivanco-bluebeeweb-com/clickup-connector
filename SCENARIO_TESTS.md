# Plausible Scenario Tests (PST) — ClickUp Connector
...
- `connect_clickup`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_clickup`: validated contract & error handling
- `list_teams`: validated contract & error handling
- `list_spaces`: validated contract & error handling
- `list_folders`: validated contract & error handling
- `list_lists`: validated contract & error handling
- `list_tasks`: validated contract & error handling
